FIND_PATH(TINYPLY_INCLUDE_DIR NAMES tinyply.h
            ...
            ${PROJECT_BINARY_DIR}/external/tinyply/bin/include
            /usr/include/
            /usr/local/include/
            NO_DEFAULT_PATH
            )
...
FIND_LIBRARY(TINYPLY_LIBRARY
            ...
            ${PROJECT_BINARY_DIR}/external/tinyply/bin/lib
            )

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(tinyply DEFAULT_MSG TINYPLY_LIBRARY TINYPLY_INCLUDE_DIR)
...
MARK_AS_ADVANCED(TINYPLY_LIBRARY TINYPLY_INCLUDE_DIR)